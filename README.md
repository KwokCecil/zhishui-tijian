...
- 规则层级：R19 是 R17 的升级，同时命中时并入 R19 不重复计分。
- 政策互斥：P01 小微低税率与 P02 高新15% 互斥，同一所得择优适用，小微 5% 更优。
- 例：案例一命中 R19(20)+R35(20)=40 基础分（R17 已并入 R19），组合 +25 → 65/100 → 高风险；
  案例六命中 R36(45)+R37(20)=65 → 高风险；2 条高危 = 90 → 高风险。
